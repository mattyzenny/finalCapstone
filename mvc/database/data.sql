...
INSERT INTO curriculum (id, name, description, teacher_id, duration, category_id)
VALUES (serial, 'Algebra I', 'Algebra 1 topics include recognizing and developing patterns using tables, graphs and equations. In addition, students will explore operations on
